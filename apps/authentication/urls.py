...
urlpatterns = [
    ...
    path("phone/request-code", authviews.RequestPhoneVerificationCodeView.as_view(), name="request_phone_code"),
    path("phone/verify-code", authviews.VerifyPhoneCodeView.as_view(), name="verify_phone_code"),
