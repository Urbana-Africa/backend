...
def send_designer_welcome_email(user: User):
    ...
    try:
        ...
        context = {"designer_name": user.first_name or user.email}
...
def send_designer_new_order(order_item: OrderItem):
    ...
    try:
        ...
        context = {
            ...
            "delivery_timeline": product.delivery_timeline if product and hasattr(product, "delivery_timeline") else "As agreed",
        }
