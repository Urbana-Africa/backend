"""
Urbana Django Settings
Supports:
- api.urbanaafrica.com (Backend)
- *.urbanaafrica.com (React frontends)
- Shared auth cookies across subdomains
"""
...
COOKIE_DOMAIN = ".urbanaafrica.com" if ENV == "prod" else None
